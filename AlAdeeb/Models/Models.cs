...
namespace AlAdeeb.Models
{
    ...
    public class Course
    {
        ...
        // ربط الكورس ببنك الأسئلة الخاص به
    ...
    public class Quiz
    {
        ...
        // --- خصائص المحاكي العشوائي المضافة حديثاً ---
        public bool IsSimulator { get; set; } = false;
        public int SimulatorSectionsCount { get; set; } = 5;
    ...
    // ==========================================
    // جداول بنك الأسئلة (المحاكي)
    // ==========================================
    public class QuestionBankSection
    {
        [Key] public int Id { get; set; }
        public int CourseId { get; set; }
        public Course Course { get; set; }
    ...
    public class BankQuestion
    {
        ...
        public QuestionBankSection Section { get; set; }
