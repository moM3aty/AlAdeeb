...
{
    [Authorize(Roles = "Student")] // حماية: لا يدخل إلا الطالب
    public class StudentController : Controller
    {
        ...
        // الحصول على معرف الطالب المسجل حالياً
        ...
        // ==========================================
        // 1. لوحة الطالب (الكورسات المشترك بها) - Read
        // ==========================================
        ...
        // ==========================================
        // 2. تصفح الكورسات المتاحة للاشتراك - Read
        // ==========================================
        public async Task<IActionResult> BrowseCourses()
        {
            int studentId = GetCurrentStudentId();

            // جلب الكورسات المفعلة التي لم يشترك بها الطالب بعد
        ...
        // ==========================================
        // 3. الاشتراك ورفع الإيصال - Create
        // ==========================================
        [HttpGet]
        ...
        // ==========================================
        // 4. عرض محتوى الكورس للطالب - Read
        // ==========================================
        public async Task<IActionResult> CourseContent(int id)
        {
            int studentId = GetCurrentStudentId();

            // التأكد أن الطالب مشترك ومفعل في هذا الكورس
            ...
            // جلب البثوث المباشرة الخاصة بالكورس
        ...
        public async Task<IActionResult> UpdateProfile(string FullName, string PhoneNumber, string NewPassword)
        {
            ...
            if (student != null)
            {
                ...
                student.Username = PhoneNumber; // تحديث اسم المستخدم ليكون رقم الجوال الجديد
